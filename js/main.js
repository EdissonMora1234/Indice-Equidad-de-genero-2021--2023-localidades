document.addEventListener('DOMContentLoaded', function() {
    ...
    var wmsLayers = [
        { url: 'https://geoserver.scrd.gov.co/geoserver/Investigacion_Cultured_Maps/wms', layerName: 'Investigacion_Cultured_Maps:Subindice_de_Equidad_de_Genero_2021', displayName: 'Subindice_Equidad_de_Genero_2021' },
        { url: 'https://geoserver.scrd.gov.co/geoserver/Investigacion_Cultured_Maps/wms', layerName: 'Investigacion_Cultured_Maps:Subindice_de_Equidad_de_Genero_2023', displayName: 'Subindice_Equidad_de_Genero_2023' }
    ];
